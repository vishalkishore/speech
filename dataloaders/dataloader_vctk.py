...
class VCTKDemandDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        clean_mag, clean_pha, clean_com = mag_phase_stft(clean_audio, self.n_fft, self.hop_size, self.win_size, self.compress_factor, center=self.center)
        noisy_mag, noisy_pha, noisy_com = mag_phase_stft(noisy_audio, self.n_fft, self.hop_size, self.win_size, self.compress_factor, center=self.center)
